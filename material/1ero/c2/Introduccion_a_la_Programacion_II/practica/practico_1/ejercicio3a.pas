program Ejercicio3a ;
{
  $Id: ejercicio3a.pas,v 1.3 2016/01/30 19:06:33 aosorio Exp $
  ...
  -1.
  a) Suponga que los elementos del archivo se encuentran desordenados.
}
...
begin
  ...
  while( ( i < fileSize( archivo ) ) AND not encontrado ) do
    begin
    read( archivo, valor ) ;
